...
// ///////////////////////////////////////////////
        isotop:function(){
            if($('.isotop-filter').exists()){
                loadScript($assetsPath1 + '/isotope.pkgd.min.js', function(){
...
// ///////////////////////////////////////////////
        fancyBox:function(){
            if($('[data-fancybox]').exists()){
                loadScript($assetsPath1 + '/jquery.fancybox.min.js', function(){
...
// ///////////////////////////////////////////////
        owlCarousel:function(){
            if($('.owl-carousel').exists()){
                loadScript($assetsPath1 + '/owl.carousel.min.js', function(){
