                ...
                <form action="{{ route('admin.blogs.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        <div style="display:flex;">
                            ...
                            <select id=category_id class="form-control custom-select mt-15 @error('category_id') is-invalid @enderror" name="category_id" required>
...
<style>
                        ...
                        <div id="container">
                            <textarea id="editor" class="ckeditor form-control @error('details') is-invalid @enderror " rows="4" name="details" id="details">{{ old('details') }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {{-- <textarea class="ckeditor form-control @error('about_author') is-invalid @enderror " rows="4" name="about_author" id="about_author">{{ old('about_author') }}</textarea> --}}
                            ...
                            <div id="container">
                                <textarea id="editor1" class="ckeditor form-control @error('about_author') is-invalid @enderror " rows="4" name="about_author">{{ old('about_author') }}</textarea>
                            </div>
