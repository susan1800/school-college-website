                            ...
                            @if ($notice->id != 0)
                                <tr>
                                    ...
                                    <td class="text-center">
                                            ...
                                            <a  class="btn btn-sm btn-danger" onclick="deletefunction('<?= $notice->id ?>')"><i class="fa fa-trash"></i></a>
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    $.ajax({url: "https://uttarpustika.com/admin/notices/"+id+"/delete", success: function(result){
