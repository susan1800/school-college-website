                    ...
                    <div class="tile-body">
                        ...
                        <div style="display: flex">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control @error('time') is-invalid @enderror" type="time" name="time" id="time" value="{{ old('time') }}"/>
                        ...
                        <div style="display: flex">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control @error('fee') is-invalid @enderror" type="text" name="fee" id="fee" value="{{ old('fee') }}"/>
                                @error('fee') {{ $message }} @enderror
                            </div>

                            <div class="form-group col-md-6">
                                <label class="control-label" for="total_slots">total slots <span class="m-l-5 text-danger"> *</span></label>
                                <input class="form-control @error('total_slots') is-invalid @enderror" type="text" name="total_slots" id="total_slots" value="{{ old('total_slots') }}"/>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="bio">Details<span class="m-l-5 text-danger"> *</span></label>
