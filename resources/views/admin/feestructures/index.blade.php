...
@section('content')
    <div class="app-title">
        ...
        <a href="{{ route('admin.feestructures.create') }}" class="btn btn-primary pull-right">Add feestructure</a>
    </div>
                ...
                <div class="tile-body">
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tr>
                            ...
                            <th rowspan="2" class="text-center text-danger"><i class="fa fa-bolt"> </i></th>
                        </tr>
                        <tr>
                            <th>Science</th>
                            <th>Management</th>
                        ...
                        @foreach($feestructures as $feestructure)
                            @if ($feestructure->id != 0)
                                <tr>
                                    ...
                                    <td>{{ $feestructure->humanities}}</td>
                                    <td>{{ $feestructure->bbs}}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Second group">
                                            ...
                                            <a href="{{ route('admin.feestructures.disable', $feestructure->id) }}" class="btn btn-sm btn-primary" style="margin:3px;"> <i class="fa fa-eye" aria-hidden="true"></i> </a>
                                            @else
