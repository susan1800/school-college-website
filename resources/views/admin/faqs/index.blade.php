                                ...
                                <tr >
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Second group">
                                             @if($faq->status == 1)
                                            <a href="{{ route('admin.faqs.disable', $faq->id) }}" class="btn btn-sm btn-primary" style="margin:3px;"> <i class="fa fa-eye" aria-hidden="true"></i> </a>
                                            @else
                                            <a href="{{ route('admin.faqs.disable', $faq->id) }}" class="btn btn-sm btn-danger" style="margin:3px;"> <i class="fa fa-eye-slash" aria-hidden="true"></i> </a>
                                            @endif
                                            <a href="{{ route('admin.faqs.edit', $faq->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                            <a onclick="deletefunction('<?= $faq->id ?>')" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    $.ajax({url: "https://uttarpustika.com/admin/faqs/"+id+"/delete", success: function(result){
