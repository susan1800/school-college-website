...
<script>
     function checksubtitle(){
        ...
        if(title=='tribhuvan university'){
            ...
            var option = document.createElement("option");
            option.value = "science in computer science and information technology";
            option.text = "Science in Computer Science and Information Technology";
            x.add(option);
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <form action="{{ route('admin.boards.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <select id=title class="form-control custom-select mt-15 @error('title') is-invalid @enderror" name="title" onchange="checksubtitle()">
                                ...
                                <option value="{{ $targetBoard->title }}" selected> {{ $targetBoard->title }} </option>
                            ...
                            <input type="hidden" name="id" value="{{ $targetBoard->id }}">
                            <input type="hidden" name="hiddensubtitle" value="{{ $targetBoard->subtitle }}">
                        ...
                        <div class="form-group">
                            ...
                            <select id=subtitle class="form-control custom-select mt-15 @error('subtitle') is-invalid @enderror" name="subtitle" >
                                ...
                                <option value="{{ $targetBoard->subtitle }}" selected> {{ $targetBoard->subtitle }} </option>
                    ...
                    <div class="tile-footer">
                        <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update Board</button>
                        &nbsp;&nbsp;&nbsp;
