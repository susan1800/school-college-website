...
@section('content')
    <div class="app-title">
        ...
        <a href="{{ route('admin.hostelfees.create') }}" class="btn btn-primary pull-right">Add data</a>
    </div>
                        ...
                        @foreach($hostelfees as $hostelfee)
                            @if ($hostelfee->id != 0)
                                <tr>
                                    ...
                                    <td>{{ $hostelfee->remarks }}</td>


                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Second group">
                                            @if($hostelfee->status == 1)
                                            <a href="{{ route('admin.hostelfees.disable', $hostelfee->id) }}" class="btn btn-sm btn-primary" style="margin:3px;"> <i class="fa fa-eye" aria-hidden="true"></i> </a>
                                            @else
