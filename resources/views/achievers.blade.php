    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-12 text-center mb-md-4">
                <h2 class="mb-4">
                    It has been proven that we are the best in this field.
                </h2>
...
<main class="main-content">
    ...
    <div class=" col-lg-2 " data-aos="fade-up" style="padding:5px;">
        <a class="d-block photo-item">
    <img src="{{asset('storage/'.$achiever->image)}}" alt="Image" class="img-fluid" width="100%" height="100%">
    <div class="photo-text-more">
    <div class="photo-text-more">
    <h3 class="heading">{{$achiever->achievement}}</h3>
    <span class="meta"> {{$achiever->name}} </span>
    </div>
    </div>
        </a>
    </div>
